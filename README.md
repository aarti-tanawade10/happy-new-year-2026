...
* Color-Shift Message: The "HAPPY NEW YEAR" text smoothly transitions between Cyan, Pink, Purple and Yellow with a glowing neon effect.
...
* CSS3 - For Flexbox centering and Keyframe animations.
* JavaScript - For the Canvas particle system and physics logic.
